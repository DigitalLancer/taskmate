    ...
    <>
      <div className='list-element'>
        <div className="todo-content-container">
          ...
          <button className="edit-btn" onClick={handleToggleEdit}><i class="fa-solid fa-pencil"></i></button>
        </div>
        <div className={`edit-form-container ${editMode ? 'active' : ''}`}>
          ...
          <div className='color-pick'>
            ...
            <div className="colors-container">
              <button className='highlight-color yellow' onClick={() => setHighlightColor('yellow')}></button>
              <button className='highlight-color red' onClick={() => setHighlightColor('red')}></button>
              <button className='highlight-color green' onClick={() => setHighlightColor('#44e200')}></button>
            </div>
          </div>
        </div>
      </div>
